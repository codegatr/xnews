...
<footer><div class="kapsayici">
    ...
    <div class="footer-otomatik-bildirim">
        <svg class="foe-ikon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-6.219-8.56"/><path d="M21 3v6h-6"/></svg>
        <span>İçerikler her <strong><?= h(ayar('otomatik_guncelleme_dk', '10')) ?> dakikada bir</strong> otomatik olarak yüklenmekte ve güncellenmektedir.</span>
    </div>
